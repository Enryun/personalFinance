...
const SudokuZen = () => {
    return (
        <div className="sudokuzen">
            <h3 className="sudoku_title">Sudoku Zen: Challenge Your Mind, Relax Your Soul</h3>
            {/* App Logo */}
            ...
            <div className="policy-link-container">
                <Link to="/policy/sudoku-zen" className="policy-link">
