...
const GalaxyGalleryPolicy = () => {
  return (
    <div className="policy">
      <strong>Privacy Policy</strong>{" "}
      <p>
        James Thang built the Galaxy Gallery AR app as a Commercial app. This
        SERVICE is provided by James Thang and is intended for use as is.
      </p>{" "}
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which is accessible at Finance Advisor unless
      ...
      <p>
        ...
        but not limited to James Thang. The information that I request will be
      ...
      <p>This policy is effective as of 2020-09-06</p>{" "}
      <p>
        <strong>Contact Us</strong>
      </p>{" "}
      <p>
        If you have any questions or suggestions about my Privacy Policy, do not
        hesitate to contact me at jamesthang1996@gmail.com.
      </p>{" "}
      <p>
...
export default GalaxyGalleryPolicy;
