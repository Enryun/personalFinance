...
const PolicyNeonCloud = () => {
  return (
    <div className="policy">
      <strong>Privacy Policy</strong>{" "}
      <p>
        James Thang built the Neon Cloud app as a Free app. This SERVICE is provided by
        James Thang at no cost and is intended for use as is.
      </p>{" "}
      <p>
      ...
      <p>
        ...
        Neon Cloud unless otherwise defined in this Privacy Policy.
      </p>{" "}
      <p>
...
export default PolicyNeonCloud;
