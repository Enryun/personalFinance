...
const PolicyDarkHorse = () => {
  return (
    <div className="policy">
      <strong>Privacy Policy</strong>{" "}
      <p>
        James Thang built the DarkHorse app as a Free app. This SERVICE is provided by
      ...
      <p>
        ...
        DarkHorse unless otherwise defined in this Privacy Policy.
      </p>{" "}
      <p>
...
export default PolicyDarkHorse;
