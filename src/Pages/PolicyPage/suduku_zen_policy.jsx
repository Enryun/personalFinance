...
const PolicySudokuZen = () => {
  return (
    <div className="policy">
      <strong>Privacy Policy</strong>{" "}
      <p>
        James Thang built the Sudoku Zen app as a Free app. This
      ...
      <p>This policy is effective as of 2024-11-07</p>{" "}
      <p>
...
export default PolicySudokuZen;
