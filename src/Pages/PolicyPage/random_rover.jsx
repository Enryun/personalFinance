...
const RandomRoverPolicy = () => {
  return (
    <div className="policy">
      <strong>Privacy Policy</strong>{" "}
      <p>
        James Thang built the Random Rover app as a Commercial app. This
      ...
      <p>
        ...
        Terms and Conditions, which is accessible at Random Rover unless
...
export default RandomRoverPolicy;