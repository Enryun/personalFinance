...
const PolicyWordSearch = () => {
  return (
    <div className="policy">
      <strong>Privacy Policy</strong>{" "}
      <p>
        James Thang built the Word Search app as a Free app. This
        SERVICE is provided by James Thang at no cost and is intended for use as
        is.
      </p>{" "}
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which is accessible at Sudoku Magic Square unless
      ...
      <p>
        ...
        but not limited to Duong Dinh Bao Thang, Ho Chi Minh City. The
      ...
      <p>This policy is effective as of 2025-02-02</p>{" "}
      <p>
...
export default PolicyWordSearch;
